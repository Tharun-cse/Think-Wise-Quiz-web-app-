...
let questionColl = [];
let optionColl = [];
const answerColl = [1, 1, 3, 3, 0, 2, 0]; // correct answer of the following quiz questions
...
questionColl[1] = "Who among the following considered as the 'father of artificial intelligence'? ";
optionColl[1] = {
    options: ['JP Eckert', 'John McCarthy', 'Lee De Forest', 'Charles Babbage']
};
...
questionColl[6] = " Which of the following is the first calculating device?";
optionColl[6] = {
    options: ['Abacus', 'Turing Machine', 'Calculator', 'Pascaline']
};
/********** end of questions ***** */
